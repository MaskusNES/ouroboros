...
Tools:
  ...
  ai_digest_check  — фоновая проверка: запускать дайджест раз в неделю (consciousness_only)
"""
    ...
    return [
        ...
        ToolEntry(
            "ai_digest_check",
            {
                ...
                "description": (
                    "Фоновая проверка: запустить еженедельный дайджест AI-приложений "
                    "если прошло >= 7 дней с последнего запуска. "
                    "Вызывается из фонового сознания."
                ),
                "parameters": {"type": "object", "properties": {}, "required": []},
            },
